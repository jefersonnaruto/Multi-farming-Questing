...
function HmFlashQuest:randomZoneExp()
	if self.zoneExp == 1 then
			return moveToRectangle(26,29,31,30)
		
	elseif self.zoneExp == 2 then
			return moveToRectangle(25,33,32,33)
		
	elseif self.zoneExp == 3 then
			return moveToRectangle(34,42,40,45)
		
	elseif	self.zoneExp == 4 then
			return moveToRectangle(37,58,40,58)
	elseif	self.zoneExp == 5 then
			return moveToRectangle(20,43,26,43)	
	else	
			return moveToRectangle(33,67,41,67)
	end
end
