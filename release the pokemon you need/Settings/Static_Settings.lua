...
--  Default Settings
    default        = {
        ...
        K_SUBWAY   = 1444445, -- Weight for using the subway path. Kanto
        J_SUBWAY   = 14444445, -- Weight for using the subway path. Johto
        H_SUBWAY   = 94444499, -- Weight for using the subway path. Hoenn

        J_TO_K     = 144444440, -- Weight of the Subway from Johto to Kanto and reverse.
        H_TO_KJ    = 1440 -- Weight of the Subway from Hoenn to Kanto/Johto and reverse.
    },
