...
function CascadeBadgeQuest:CeruleanCity()
	if   self.registeredPokecenter ~= "Pokecenter Cerulean" or not game.isTeamFullyHealed() then
...
function CascadeBadgeQuest:Route9()
	return moveToMap("Route 10")
end

function CascadeBadgeQuest:Route10()
	return  moveToGrass()
end
